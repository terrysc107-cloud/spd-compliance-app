---
name: "SPD Presentations"
description: "Staff meeting deck and leadership presentation design skill for Sterile Processing. Use when: building the monthly staff meeting presentation for Pete's night shift, Heather's day shift, or Eve's evening shift team, designing a KPI dashboard slide for administration or CNO, creating a leadership briefing on quality trends, building a capital investment case in slide format, designing a survey readiness awareness presentation for staff, creating an orientation deck for new SPD hires, building a joint SPD-IP presentation for shared governance, presenting a corrective action update to administration, or designing any slide-based communication requiring clear data visualization, narrative structure, and professional formatting. Data without narrative is not a presentation — every deck tells a story."
---
...
- Do NOT present data without interpretation — explain what the number means, not just what it is
- Do NOT put paragraphs of text on slides — use speaker notes for the narrative
- Do NOT design a staff meeting deck that is just a data review — include a focus topic, a win, and a Q&A
- Do NOT use checkbox symbols in any slide — bullet points only
- Do NOT send a leadership dashboard without trend indicators — a snapshot without trend is not actionable

## Wiring

**Called by:** spd-orchestrator (presentation requests), spd-analytics (data → dashboard), spd-capital-justification (capital request slides), spd-survey-readiness (survey readiness briefing)
**Calls:** spd-analytics (data sourcing), spd-quality-gate (before leadership and SAG deliverable presentations), spd-document-design (formatting and branding standards)
